...
const hcsComputeSystemSaveType = "AsTemplate"
...
type Cloneable interface {
	...
	// gob encoding is used to serialize and deserialize resources but a resource
	// can implement `gob.GobEncoder` & `gob.GobDecoder` interfaces to provide its own
